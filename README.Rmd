...
ASAP facilitates large-scale longitudinal studies of song development by: 
-   📊 Processing and analyzing complex vocal patterns

-   🔍 Detecting and visualizing feature changes in high-dimensional acoustic space

-   🧬 Providing white-box algorithms for investigating song evolution in latent space
...
```{r, example,fig.width=12, fig.height=6, out.width="100%"}
library(ASAP)
