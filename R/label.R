...
# Prevent R CMD check notes for bare variable names used in dplyr verbs
utils::globalVariables(c("start_time", "end_time", "motif_start", "motif_end",
                         "filename", "day_post_hatch", "label", "UMAP1",
                         "UMAP2", "cleaned_cluster", "segment_duration",
                         ".time", "merged_cluster", "old_cluster",
                         "new_cluster", "row", "col", "from_id", "to_id",
                         "cluster_id"))
