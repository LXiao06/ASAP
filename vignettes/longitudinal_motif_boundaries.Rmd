...
```{r plot_boundaries_fig, echo = FALSE, eval = TRUE, out.width = "100%",
    fig.cap = "Amplitude-envelope heatmap with motif onset (green) and offset (cyan) markers. Each row is one motif; labels (BL, Post, Rec) are separated by white horizontal lines."}
...
```{r plot_boundaries_ordered_fig, echo = FALSE, eval = TRUE, out.width = "100%",
    fig.cap = "UMAP-ordered boundary heatmap. Acoustically similar motifs are grouped together, making consistent boundary placement easier to verify."}
...
```{r plot_boundaries_clusters_fig, echo = FALSE, eval = TRUE, out.width = "100%",
    fig.cap = "Cluster-specific boundary heatmap showing only motifs in clusters 0 and 1, ordered by UMAP coordinates."}
