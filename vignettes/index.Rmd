...
<div class="gs-grid">
  ...
  <a class="gs-card" href="exporting_song_clips.html">
    ...
    <div class="gs-card-body">
      <div class="gs-card-title">Song Motif/Bout Exportation</div>
      <div class="gs-card-desc">
        Export raw recordings into tightly cropped motif or bout-level 
        audio files in WAV or HDF5 format for external pipelines.
      </div>
      <span class="gs-card-tag">Intermediate &middot; ~10 min</span>
    </div>
  </a>
