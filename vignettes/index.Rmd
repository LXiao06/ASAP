...
<div class="gs-grid">
  ...
  <a class="gs-card" href="single_wav_analysis.html">
    <div class="gs-card-img-wrap">
      <img src="figures/basic_audio_analysis.png"
           alt="Overview vignette showing spectrogram-based audio exploration">
    </div>
    <div class="gs-card-body">
      <div class="gs-card-title">Overview: ASAP 101</div>
  ...
  <!-- Card 3 -->
  <a class="gs-card" href="acoustic_feature_analysis.html">
    <div class="gs-card-img-wrap">
      <img src="figures/acoustic_feature_analysis.png"
           alt="Spectral entropy analysis plot">
    </div>
    <div class="gs-card-body">
      <div class="gs-card-title">Acoustic Feature Analysis</div>
      <div class="gs-card-desc">
  ...
  <!-- Card 4 -->
  <a class="gs-card" href="advanced_acoustic_feature_analysis.html">
    <div class="gs-card-img-wrap">
      <img src="figures/acoustic_feature_analysis.png"
           alt="Feature trajectory plots across motif renditions">
    </div>
    <div class="gs-card-body">
      <div class="gs-card-title">Advanced Acoustic Feature Analysis</div>
      <div class="gs-card-desc">
...
<div class="gs-grid">
  ...
  <!-- Card 6 -->
  <a class="gs-card" href="exporting_song_clips.html">
    <div class="gs-card-img-wrap" style="background:#fff;">
      <img src="figures/exporting_clips_card.png"
           alt="Conceptual illustration of audio motif and bout extraction">
    </div>
    <div class="gs-card-body">
      <div class="gs-card-title">Exporting Curated Song Clips</div>
      <div class="gs-card-desc">
        Generate precisely cropped motif or bout-level audio files (WAV or 
        HDF5) from raw recordings for use in external processing pipelines.
      </div>
      <span class="gs-card-tag">Intermediate &middot; ~10 min</span>
    </div>
  </a>
  ...
  <a class="gs-card" href="longitudinal_syllable_segmentation.html">
    <div class="gs-card-img-wrap" style="background:#fff;">
      <img src="figures/longitudinal_syllable_umap.png"
  ...
  <a class="gs-card" href="syllable_labeling.html">
    <div class="gs-card-img-wrap" style="background:#fff;">
      <img src="figures/longitudinal_syllable_manual_heatmap.png"
  ...
  <!-- Card 9 -->
  <a class="gs-card" href="longitudinal_motif_boundaries.html">
    <div class="gs-card-img-wrap" style="background:#fff;">
      <img src="figures/motif_boundaries_heatmap.png"
           alt="Amplitude-envelope heatmap with onset (green) and offset (cyan) boundary markers">
    </div>
    <div class="gs-card-body">
      <div class="gs-card-title">Identifying Motif Boundaries</div>
      <div class="gs-card-desc">
  ...
  <!-- Card 10 -->
  <a class="gs-card" href="longitudinal_motif_trajectory.html">
    <div class="gs-card-img-wrap" style="background:#fff;">
      <img src="figures/motif_trajectory_umap.png"
           alt="UMAP of motif trajectory embeddings coloured by developmental label">
    </div>
    <div class="gs-card-body">
      <div class="gs-card-title">Longitudinal Motif Trajectory Analysis</div>
      <div class="gs-card-desc">
  ...
  <!-- Card 11 -->
  <a class="gs-card" href="longitudinal_motif_similarity.html">
    <div class="gs-card-img-wrap" style="background:#fff;">
      <img src="figures/motif_trajectory_similarity.png"
           alt="Per-label trajectory similarity distributions coloured by metric">
    </div>
    <div class="gs-card-body">
      <div class="gs-card-title">Longitudinal Motif Similarity Analysis</div>
      <div class="gs-card-desc">
        Filter outlier renditions, compute per-label trajectory similarity to
        a baseline reference using RMS, Fréchet, DTW, and correlation metrics,
        and visualise how acoustic convergence changes across developmental stages.
      </div>
      <span class="gs-card-tag">Advanced &middot; ~20 min</span>
    </div>
  </a>
