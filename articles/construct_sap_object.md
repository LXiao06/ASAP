...
This flexible approach also works for **multi-modal recording data**,
where song recordings are synchronized with other data types such as:

- **Fiber photometry** (dopamine/calcium signals)
- **Electrophysiology** recordings
- **Behavioral video** timestamps

By organizing your data with consistent naming conventions, you can
integrate song analysis with neural or behavioral data streams.

For a detailed example of multi-modal data processing with ASAP, see:
[Juvenile DA Analysis - Data
