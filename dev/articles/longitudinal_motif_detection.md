...
- [Overview: Basic Audio
  Analysis](https://lxiao06.github.io/ASAP/dev/articles/single_wav_analysis.md) -
  Core ASAP functions
- [Motif
...
After completing the motif detection pipeline, you can save the SAP
...
**What gets saved:** - All metadata and file references - Template
detection results - Motif boundaries - Spectral features and UMAP
