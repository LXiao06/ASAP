...
- [`plot_trajectory_trials()`](https://lxiao06.github.io/ASAP/dev/reference/plot_trajectory_trials.md)
...
Functions for analyzing song trajectories, similarity to reference, and
variability
...
- [`flag_anomalous_labels()`](https://lxiao06.github.io/ASAP/dev/reference/flag_anomalous_labels.md)
